...
export MARACLUSTER_BINARY="/tmp/openms-stuff/OpenMS2.6.0-git/THIRDPARTY/Linux/64bit/MaRaCluster/maracluster"
...
export SPECTRAST_BINARY="/tmp/openms-stuff/OpenMS2.6.0-git/THIRDPARTY/Linux/64bit/SpectraST/spectrast"
...
DatabaseSuitability -test -in_id DatabaseSuitability_in_id.idXML -in_spec DatabaseSuitability_in_spec.mzML -in_novo DatabaseSuitability_in_novo.idXML -algorithm:FDR 0.8 -out DatabaseSuitability_1.tmp > TOPP_DatabaseSuitability_1.stdout 2> TOPP_DatabaseSuitability_1.stderr
...
DatabaseSuitability -test -in_id DatabaseSuitability_in_id.idXML -in_spec DatabaseSuitability_in_spec.mzML -in_novo DatabaseSuitability_in_novo.idXML -algorithm:FDR 1 -algorithm:reranking_cutoff_percentile 0.9 -out DatabaseSuitability_2.tmp > TOPP_DatabaseSuitability_2.stdout 2> TOPP_DatabaseSuitability_2.stderr
...
DatabaseSuitability -test -in_id DatabaseSuitability_in_id.idXML -in_spec DatabaseSuitability_in_spec.mzML -in_novo DatabaseSuitability_in_novo.idXML -algorithm:FDR 0.9 -algorithm:no_rerank -out DatabaseSuitability_3.tmp > TOPP_DatabaseSuitability_3.stdout 2> TOPP_DatabaseSuitability_3.stderr
...
echo executing "TOPP_FeatureFinderIdentification_4"
FeatureFinderIdentification -test -in FeatureFinderIdentification_1_input.mzML -id FeatureFinderIdentification_1_input.idXML -out FeatureFinderIdentification_4.tmp -extract:mz_window 0.1 -detect:peak_width 60 -model:type symmetric -model:each_trace > TOPP_FeatureFinderIdentification_4.stdout 2> TOPP_FeatureFinderIdentification_4.stderr
...
echo executing "TOPP_FeatureFinderIdentification_4"
FeatureFinderIdentification -test -in FeatureFinderIdentification_1_input.mzML -id FeatureFinderIdentification_1_input.idXML -out FeatureFinderIdentification_4.tmp -candidates_out FeatureFinderIdentification_4_candidates.tmp -extract:mz_window 0.1 -extract:batch_size 10 -detect:peak_width 60 -model:type none > TOPP_FeatureFinderIdentification_4.stdout 2> TOPP_FeatureFinderIdentification_4.stderr
if [[ "$?" -ne "0" ]]; then >&2 echo 'TOPP_FeatureFinderIdentification_4 failed'; >&2 echo -e "stderr:\n$(cat TOPP_FeatureFinderIdentification_4.stderr | sed 's/^/    /')"; echo -e "stdout:\n$(cat TOPP_FeatureFinderIdentification_4.stdout)";fi
...
echo executing "TOPP_GNPSExport_4"
...
echo executing "TOPP_InspectAdapter_1"
...
echo executing "TOPP_InspectAdapter_2"
...
echo executing "UTILS_FeatureFinderSuperHirn_1"
...
echo executing "UTILS_FeatureFinderSuperHirn_2"
...
ProteomicsLFQ -in examples/FRACTIONS/BSA1_F1.mzML examples/FRACTIONS/BSA1_F2.mzML examples/FRACTIONS/BSA2_F1.mzML examples/FRACTIONS/BSA2_F2.mzML examples/FRACTIONS/BSA3_F1.mzML examples/FRACTIONS/BSA3_F2.mzML -ids examples/FRACTIONS/BSA1_F1.idXML examples/FRACTIONS/BSA1_F2.idXML examples/FRACTIONS/BSA2_F1.idXML examples/FRACTIONS/BSA2_F2.idXML examples/FRACTIONS/BSA3_F1.idXML examples/FRACTIONS/BSA3_F2.idXML -design examples/FRACTIONS/BSA_design.tsv -Alignment:max_rt_shift 0 -fasta examples/TOPPAS/data/BSA_Identification/18Protein_SoCe_Tr_detergents_trace_target_decoy.fasta -targeted_only true -transfer_ids mean -mass_recalibration false -out_cxml BSA_plusTransfer.consensusXML.tmp -out_msstats BSA_plusTransfer.csv.tmp -out BSA_plusTransfer.mzTab.tmp -threads 4 -proteinFDR 0.3 -test  > UTILS_ProteomicsLFQ_2.stdout 2> UTILS_ProteomicsLFQ_2.stderr
...
ProteomicsLFQ -in examples/FRACTIONS/BSA1_F1.mzML examples/FRACTIONS/BSA1_F2.mzML examples/FRACTIONS/BSA2_F1.mzML examples/FRACTIONS/BSA2_F2.mzML examples/FRACTIONS/BSA3_F1.mzML examples/FRACTIONS/BSA3_F2.mzML -ids examples/FRACTIONS/BSA1_F1.idXML examples/FRACTIONS/BSA1_F2.idXML examples/FRACTIONS/BSA2_F1.idXML examples/FRACTIONS/BSA2_F2.idXML examples/FRACTIONS/BSA3_F1.idXML examples/FRACTIONS/BSA3_F2.idXML -design examples/FRACTIONS/BSA_design.tsv -Alignment:max_rt_shift 0 -fasta examples/TOPPAS/data/BSA_Identification/18Protein_SoCe_Tr_detergents_trace_target_decoy.fasta -targeted_only false -transfer_ids mean -mass_recalibration false -out_cxml BSA_plusSeeds_plusTransfer.consensusXML.tmp -out_msstats BSA_plusSeeds_plusTransfer.csv.tmp -out BSA_plusSeeds_plusTransfer.mzTab.tmp -threads 4 -proteinFDR 0.3 -test  > UTILS_ProteomicsLFQ_3.stdout 2> UTILS_ProteomicsLFQ_3.stderr
...
SiriusAdapter -test -executable "${SIRIUS_BINARY}" -in SiriusAdapter_2_input.mzML -in_featureinfo SiriusAdapter_2_input.featureXML  -out_sirius SiriusAdapter_4_output.tmp -out_fingerid SiriusAdapter_4_foutput.tmp -sirius:auto_charge -sirius:profile qtof -sirius:database pubchem > TOPP_SiriusAdapter_4.stdout 2> TOPP_SiriusAdapter_4.stderr
